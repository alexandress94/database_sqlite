...
class DatabaseHelper{
  ...
  // ...
  static final String _createTableTodo = 
  "CREATE TABLE $_table("
  ...
  Future< Database > _initDatabase( ) async{
    ...
    var todoDatabase    = await openDatabase(
      path, version: _databaseVersion, onCreate: _onCreate, /*onUpgrade: _onUpgrade,*/ );
    return todoDatabase; 
  }
  ...
  Future< int > delete( int id ) async {
    Database db = await instance.database;
    return await db.delete(_table, where: '$_columnId = ?', 
    whereArgs: [id]);
  }
